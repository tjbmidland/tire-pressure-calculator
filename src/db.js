...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS bikes (
    ...
    casing_type TEXT DEFAULT 'endurance' CHECK(casing_type IN ('extralight', 'standard', 'endurance', 'endurance_plus')),
  ...
  CREATE TABLE IF NOT EXISTS setups (
    ...
    frame_load_weight REAL DEFAULT 0,
    weight_unit TEXT DEFAULT 'lbs' CHECK(weight_unit IN ('kg', 'lbs')),
    bike_type TEXT DEFAULT 'gravel' CHECK(bike_type IN ('road', 'gravel', 'mountain')),
